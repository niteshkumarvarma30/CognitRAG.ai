...
import { Search, File, GitBranch, MessageSquare } from 'lucide-react';
        ...
        <div className="panel-body">
          {documents.length === 0 ? (
            ...
            <div className="flex-col">
              {documents.map((doc) => (
                <div key={doc.id} style={{ padding: '1rem', borderBottom: '1px solid var(--border-light)', display: 'flex', justifyContent: 'space-between' }}>
                  <div>
